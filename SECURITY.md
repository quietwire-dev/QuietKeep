...
| Trivy | backend/requirements.txt (pip) | 0 vulnerabilities | 2026-05-01 |
| Trivy | frontend/package-lock.json (npm) | 0 vulnerabilities | 2026-05-01 |
| Semgrep | Codebase | 0 findings (518 rules, 82 files) | 2026-05-01 |
| ScanCode | 110 project files | AGPL-3.0 consistent, no conflicts | 2026-05-01 |
